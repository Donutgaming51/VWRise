...
local function install_profiles(num)
    ...
    local repoOwner = RiseMode and "Donutgaming51/RiseProfiles" or "Donutgaming51/VoidwareProfiles"
...
local url = RiseMode and "https://github.com/Donutgaming51/VWRise/" or "https://github.com/Donutgaming51/StraightwareBakup"
...
if not shared.VapeDeveloper then 
	local commit = "main"
	for i,v in pairs(game:HttpGet("https://github.com/Donutgaming51/straightware"):split("\n")) do 
		if v:find("commit") and v:find("fragment") then 
			local str = v:split("/")[5]
			commit = str:sub(0, str:find('"') - 1)
			break
...
local function vapeGithubRequest(scripturl, isImportant)
    ...
    local suc, res
    local url = (scripturl == "MainScript.lua" or scripturl == "GuiLibrary.lua" or scripturl == "NewMainScript.lua") and RiseMode and "https://raw.githubusercontent.com/Donutgaming51/VWRise/" or "https://raw.githubusercontent.com/Donutgaming51/StraightwareBakup/"
